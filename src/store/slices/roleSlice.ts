...
import type { ASYNC_FETCH_STATUS } from './../../interface/store/normal.d';
...
// 异步操作 获取角色列表信息
export const fetchRolesInfoData = createAsyncThunk<RolesInfoResponse[], void, { state: RootState }>("/role/info",async(_,thunkAPI)=>{
    try {
